        ...
        <div className="mx-[60px] py-8 space-y-7">
          ...
          <div className="flex gap-2 justify-between">
            <img
              ...
              className="h-28 w-28 shadow-md pt-[5px]"
            />
          ...
          <div className="relative overflow-x-auto my-6 md:my-8 text-slate-800 font-normal space-y-1 !text-left">
            <div className="flex gap-2 justify-between">
              ...
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.name}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
              <p className='print-content-serif'>Туулган датасы/Date of birth:</p>
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.birthDate}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
            ...
            <div className="flex gap-2 justify-between">
              ...
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.passportNumber}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
              <p className='print-content-serif'>Жол жүрүүчү документтин түрү/Type of travel document:</p>
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.passportType}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
              <p className='print-content-serif'>
              ...
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.passportIssueDate}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
              <p className='print-content-serif'>
              ...
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.passportExpirationDate}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
              <p className='print-content-serif'>Визанын түрү/Type of visa:</p>
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.visaType}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
              <p className='print-content-serif'>Визанын колдонулуу мөөнөтү/Validity of visa:</p>
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.visaValidityPeriod}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
              <p className='print-content-serif'>Кирүүлөрдүн саны/Number of entries:</p>
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.entryTimes}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
              <p className='print-content-serif'>Жүрүү мөөнөтү/Period of stay(days):</p>
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.visaDuration}</h2>
              </div>
            </div>
            <div className="flex gap-2 justify-between">
            ...
            <div className="flex gap-2 justify-between">
              <p className='print-content-serif'>Визанын берилген датасы/Date of visa:</p>
              <div className="w-[160px]">
                <h2 className='print-content-serif'>{visaData?.data?.applicationStatusDate}</h2>
              </div>
            </div>
          </div>
